...
Agent 每修改一个新文件，左侧列表出现新股票；列表项前的 **▲/▼** 表示**上一次修改**的涨跌。图表右上角可切换 **A股 / 美股** 配色（默认红涨绿跌；美股为绿涨红跌），亦可在设置中修改 `kagent.colorScheme`。选中后右侧显示该文件的 K 线，并在编辑器中打开该文件源码（兼作简易文件导航）。
...
| 颜色 | 收盘 ≥ 开盘为阳线、反之为阴线；A 股为红阳绿阴，美股为绿阳红阴（`#e53935` / `#43a047`，填充/边框/影线同色） |
